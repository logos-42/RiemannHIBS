...
the zero set contains any genuinely non-self-paired orbit.
...
hypothesis, every nontrivial zero has $\Re s=1/2$ and hence lies on the
circle. Conversely, if every reflection orbit in the annulus collapses to a
self-pair, the algebra above forces $w^2=e$, and the corresponding lift has
$\Re s=1/2$. The two directions use different ingredients: the first is the
definition of the hypothesis in the original coordinate, while the second
uses the reflection pairing and the self-pair calculation.
